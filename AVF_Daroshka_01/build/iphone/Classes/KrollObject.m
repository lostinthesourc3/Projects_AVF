...
//@interface AVF_Daroshka_01Object : NSObject
//@end

@interface AVF_Daroshka_01Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVF_Daroshka_01Object class]])
		{
			for (NSString *key in [[(AVF_Daroshka_01Object*)o modules] allKeys])
			{
