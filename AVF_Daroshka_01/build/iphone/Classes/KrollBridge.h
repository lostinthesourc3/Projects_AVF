...
@interface AVF_Daroshka_01Object : KrollCoverageObject {
#else
@interface AVF_Daroshka_01Object : KrollObject {
#endif
@private
...
extern NSString * AVF_Daroshka_01$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVF_Daroshka_01Object *_avf_daroshka_01;
    KrollObject* console;
	BOOL shutdown;
