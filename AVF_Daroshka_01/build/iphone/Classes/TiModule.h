...
/**
 The base class for all AVF_Daroshka_01 modules
 */
...
/**
 AVF_Daroshka_01 Platform calls this method on startup.
 */
-(void)startup;

/**
 AVF_Daroshka_01 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AVF_Daroshka_01 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AVF_Daroshka_01 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AVF_Daroshka_01 Platform calls this method on resume.
 @param sender The sender of the event.
 */
