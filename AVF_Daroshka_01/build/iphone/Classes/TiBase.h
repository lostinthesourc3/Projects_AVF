...
// in simulator we redefine to format for AVF_Daroshka_01 Developer console
...
{\
	NSString * exceptionName = [@"org.avf_daroshka_01." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avf_daroshka_01";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVF_Daroshka_01NativeItemNone = -1, 
	UIAVF_Daroshka_01NativeItemSpinner = -2,
	UIAVF_Daroshka_01NativeItemProgressBar = -3,
	
	UIAVF_Daroshka_01NativeItemSlider = -4,
	UIAVF_Daroshka_01NativeItemSwitch = -5,
	UIAVF_Daroshka_01NativeItemMultiButton = -6,
	UIAVF_Daroshka_01NativeItemSegmented = -7,
	
	UIAVF_Daroshka_01NativeItemTextView = -8,
	UIAVF_Daroshka_01NativeItemTextField = -9,
	UIAVF_Daroshka_01NativeItemSearchBar = -10,
	
	UIAVF_Daroshka_01NativeItemPicker = -11,
	UIAVF_Daroshka_01NativeItemDatePicker = -12,
	
	UIAVF_Daroshka_01NativeItemInfoLight = -13,
	UIAVF_Daroshka_01NativeItemInfoDark = -14,
	
	UIAVF_Daroshka_01NativeItemDisclosure = -15,
	
	UIAVF_Daroshka_01NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all AVF_Daroshka_01 instances of
