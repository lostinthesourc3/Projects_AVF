...
// in simulator we redefine to format for AVF_Daroshka_022 Developer console
...
{\
	NSString * exceptionName = [@"org.avf_daroshka_022." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avf_daroshka_022";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVF_Daroshka_022NativeItemNone = -1, 
	UIAVF_Daroshka_022NativeItemSpinner = -2,
	UIAVF_Daroshka_022NativeItemProgressBar = -3,
	
	UIAVF_Daroshka_022NativeItemSlider = -4,
	UIAVF_Daroshka_022NativeItemSwitch = -5,
	UIAVF_Daroshka_022NativeItemMultiButton = -6,
	UIAVF_Daroshka_022NativeItemSegmented = -7,
	
	UIAVF_Daroshka_022NativeItemTextView = -8,
	UIAVF_Daroshka_022NativeItemTextField = -9,
	UIAVF_Daroshka_022NativeItemSearchBar = -10,
	
	UIAVF_Daroshka_022NativeItemPicker = -11,
	UIAVF_Daroshka_022NativeItemDatePicker = -12,
	
	UIAVF_Daroshka_022NativeItemInfoLight = -13,
	UIAVF_Daroshka_022NativeItemInfoDark = -14,
	
	UIAVF_Daroshka_022NativeItemDisclosure = -15,
	
	UIAVF_Daroshka_022NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all AVF_Daroshka_022 instances of
