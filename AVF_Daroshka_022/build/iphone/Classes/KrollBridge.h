...
@interface AVF_Daroshka_022Object : KrollCoverageObject {
#else
@interface AVF_Daroshka_022Object : KrollObject {
#endif
@private
...
extern NSString * AVF_Daroshka_022$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVF_Daroshka_022Object *_avf_daroshka_022;
    KrollObject* console;
	BOOL shutdown;
