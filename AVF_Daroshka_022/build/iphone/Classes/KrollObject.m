...
//@interface AVF_Daroshka_022Object : NSObject
//@end

@interface AVF_Daroshka_022Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVF_Daroshka_022Object class]])
		{
			for (NSString *key in [[(AVF_Daroshka_022Object*)o modules] allKeys])
			{
