...
/**
 The base class for all week4YD modules
 */
...
/**
 week4YD Platform calls this method on startup.
 */
-(void)startup;

/**
 week4YD Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 week4YD Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 week4YD Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 week4YD Platform calls this method on resume.
 @param sender The sender of the event.
 */
