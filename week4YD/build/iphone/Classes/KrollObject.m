...
//@interface week4YDObject : NSObject
//@end

@interface week4YDObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[week4YDObject class]])
		{
			for (NSString *key in [[(week4YDObject*)o modules] allKeys])
			{
