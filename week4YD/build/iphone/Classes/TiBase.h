...
// in simulator we redefine to format for week4YD Developer console
...
{\
	NSString * exceptionName = [@"org.week4yd." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week4yd";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIweek4YDNativeItemNone = -1, 
	UIweek4YDNativeItemSpinner = -2,
	UIweek4YDNativeItemProgressBar = -3,
	
	UIweek4YDNativeItemSlider = -4,
	UIweek4YDNativeItemSwitch = -5,
	UIweek4YDNativeItemMultiButton = -6,
	UIweek4YDNativeItemSegmented = -7,
	
	UIweek4YDNativeItemTextView = -8,
	UIweek4YDNativeItemTextField = -9,
	UIweek4YDNativeItemSearchBar = -10,
	
	UIweek4YDNativeItemPicker = -11,
	UIweek4YDNativeItemDatePicker = -12,
	
	UIweek4YDNativeItemInfoLight = -13,
	UIweek4YDNativeItemInfoDark = -14,
	
	UIweek4YDNativeItemDisclosure = -15,
	
	UIweek4YDNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all week4YD instances of
