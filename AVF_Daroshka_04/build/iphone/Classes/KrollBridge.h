...
@interface AVF_Daroshka_03Object : KrollCoverageObject {
#else
@interface AVF_Daroshka_03Object : KrollObject {
#endif
@private
...
extern NSString * AVF_Daroshka_03$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVF_Daroshka_03Object *_avf_daroshka_03;
    KrollObject* console;
	BOOL shutdown;
