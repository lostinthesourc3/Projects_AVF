...
//@interface AVF_Daroshka_03Object : NSObject
//@end

@interface AVF_Daroshka_03Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVF_Daroshka_03Object class]])
		{
			for (NSString *key in [[(AVF_Daroshka_03Object*)o modules] allKeys])
			{
