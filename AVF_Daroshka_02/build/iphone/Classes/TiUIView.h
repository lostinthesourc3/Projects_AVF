...
/**
 Base class for all AVF_Daroshka_022 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AVF_Daroshka_022 view hierarchy (such as wrapped iOS UIViews) was touched.
