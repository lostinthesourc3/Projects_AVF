...
//Rare exceptions to indicate a bug in the _avf_daroshka_022 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AVF_Daroshka_022 proxies.
 */
