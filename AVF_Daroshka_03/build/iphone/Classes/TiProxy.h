...
//Rare exceptions to indicate a bug in the _avf_daroshka_03 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AVF_Daroshka_03 proxies.
 */
