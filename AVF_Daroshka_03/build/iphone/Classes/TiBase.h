...
// in simulator we redefine to format for AVF_Daroshka_03 Developer console
...
{\
	NSString * exceptionName = [@"org.avf_daroshka_03." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avf_daroshka_03";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVF_Daroshka_03NativeItemNone = -1, 
	UIAVF_Daroshka_03NativeItemSpinner = -2,
	UIAVF_Daroshka_03NativeItemProgressBar = -3,
	
	UIAVF_Daroshka_03NativeItemSlider = -4,
	UIAVF_Daroshka_03NativeItemSwitch = -5,
	UIAVF_Daroshka_03NativeItemMultiButton = -6,
	UIAVF_Daroshka_03NativeItemSegmented = -7,
	
	UIAVF_Daroshka_03NativeItemTextView = -8,
	UIAVF_Daroshka_03NativeItemTextField = -9,
	UIAVF_Daroshka_03NativeItemSearchBar = -10,
	
	UIAVF_Daroshka_03NativeItemPicker = -11,
	UIAVF_Daroshka_03NativeItemDatePicker = -12,
	
	UIAVF_Daroshka_03NativeItemInfoLight = -13,
	UIAVF_Daroshka_03NativeItemInfoDark = -14,
	
	UIAVF_Daroshka_03NativeItemDisclosure = -15,
	
	UIAVF_Daroshka_03NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all AVF_Daroshka_03 instances of
