...
/**
 The base class for all Week3YD modules
 */
...
/**
 Week3YD Platform calls this method on startup.
 */
-(void)startup;

/**
 Week3YD Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Week3YD Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Week3YD Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Week3YD Platform calls this method on resume.
 @param sender The sender of the event.
 */
