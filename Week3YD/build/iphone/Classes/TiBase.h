...
// in simulator we redefine to format for Week3YD Developer console
...
{\
	NSString * exceptionName = [@"org.week3yd." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week3yd";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek3YDNativeItemNone = -1, 
	UIWeek3YDNativeItemSpinner = -2,
	UIWeek3YDNativeItemProgressBar = -3,
	
	UIWeek3YDNativeItemSlider = -4,
	UIWeek3YDNativeItemSwitch = -5,
	UIWeek3YDNativeItemMultiButton = -6,
	UIWeek3YDNativeItemSegmented = -7,
	
	UIWeek3YDNativeItemTextView = -8,
	UIWeek3YDNativeItemTextField = -9,
	UIWeek3YDNativeItemSearchBar = -10,
	
	UIWeek3YDNativeItemPicker = -11,
	UIWeek3YDNativeItemDatePicker = -12,
	
	UIWeek3YDNativeItemInfoLight = -13,
	UIWeek3YDNativeItemInfoDark = -14,
	
	UIWeek3YDNativeItemDisclosure = -15,
	
	UIWeek3YDNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Week3YD instances of
