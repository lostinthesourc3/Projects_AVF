...
//@interface Week3YDObject : NSObject
//@end

@interface Week3YDObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week3YDObject class]])
		{
			for (NSString *key in [[(Week3YDObject*)o modules] allKeys])
			{
